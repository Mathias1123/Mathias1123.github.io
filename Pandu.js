...
var myBackground;
var myScore;
var tombol = document.getElementById("reset")
const up = 87;
const left = 65;
const down = 83;
const right = 68;
...
function startGame() {
  player = new component(140, 75, "img/Rocket.png", 10, 190, "image");
  myScore = new component("30px", "Consolas", "white", 550, 50, "text");
  myBackground = new component(
    1200,
    600,
    "img/Background Game.png",
    0,
    0,
    "background"
  );
...
function updateGameArea() {
  ...
  if (myGameArea.frameNo == 1 || everyinterval(50)) {
    ...
    myObstacles.push(
      new component(200, 75, "img/Meteor.png", x + gap1, height, "image")
    );
    myObstacles.push(
      new component(200, 75, "img/Meteor.png", x + height1, gap, "image")
    );
  }
